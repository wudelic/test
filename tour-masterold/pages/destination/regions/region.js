...
Page({
  data: {
    multiIndex11:[0,0],
    multiArray11: [['北京', '安徽', "福建", "甘肃", "广东", "广西", "贵州", "海南", "河北", "河南", "黑龙江", "湖北", "湖南", "吉林", "江苏", "江西", "辽宁", "内蒙古", "宁夏", "青海", "山东", "山西", "陕西", "上海", "四川", "天津", "西藏", "新疆", "云南", "浙江", "重庆", "香港", "澳门", "台湾"], ['北京']],
    objectMultiArray:
    ...
    time:['00:00'],
    multiArray: [[ '是', '否']],
    multiArray2: [['1', '2', '3', '4', '5', '5人以上']],
   
    multiArray3:[ ['1天', '2天', '3天', '5天', '一周', '一周以上']],
    multiArray4: [['大巴', '飞机', '火车']],
    multiIndex4: [0, 1],
    multiIndex2: [0, 1],
    multiIndex3: [0, 1],
    // input默认是1  
  ...
  ChangeMultiPicker4(e) {
    this.setData({ multiIndex4: e.detail.value })
  },
  ...
  bindMinus2: function () {
    ...
    // 只有大于一件的时候，才能normal状态，否则disable状态  
    var minusStatus2 = num2 <= 1 ? 'disabled' : 'normal';
    // 将数值与状态写回  
    this.setData({
      num2: num2,
      minusStatus2: minusStatus2
    });
  },
  /* 点击加号 */
  bindPlus2: function () {
  ...
  bindMinus3: function () {
    ...
    // 只有大于一件的时候，才能normal状态，否则disable状态  
    var minusStatus3 = num3 <= 1 ? 'disabled' : 'normal';
    // 将数值与状态写回  
    this.setData({
      num3: num3,
      minusStatus3: minusStatus3
    });
  },
  /* 点击加号 */
  bindPlus3: function () {
  ...
  bindMultiPickerChange: function (e) {
    that.setData({
      "multiIndex11[0]": e.detail.value[0],
      "multiIndex11[1]": e.detail.value[1]
    })
  },
